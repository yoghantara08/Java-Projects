        ...
        while(data != null){
            ...
            if(updateNum == dataCounts){
                ...
                for(int i = 0; i < fieldData.length; i++){
                    boolean isUpdate = getYesNo("Apakah anda ingin merubah " + fieldData[i]);
                ...
                boolean isUpdate = getYesNo("Apakah anda yakin untuk update data");

                if(isUpdate){
                    // cek data baru di database
                    boolean isExist = checkBukuDiDatabase(tempData, false);
    ...
    private static void deleteData() throws IOException {
        ...
        while(data != null){
            ...
            if(deleteNum == dataCounts){
                ...
                isDelete = getYesNo("Apakah anda yakin akan menghapus data buku ini");
                isFound = true;
            }
